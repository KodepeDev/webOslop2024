const id = "t845.md";
						...
						new Proxy({"src":"/_astro/product-image-1.Dqz5fi0L.avif","width":1458,"height":1042,"format":"avif","fsPath":"D:/PROYECTOS ASTRO/oslopWebPage/src/images/product-image-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/PROYECTOS ASTRO/oslopWebPage/src/images/product-image-1.avif";
							}
					...
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-1.DocbQbk7.avif","width":1764,"height":1080,"format":"avif","fsPath":"D:/PROYECTOS ASTRO/oslopWebPage/src/images/product-image-main-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/PROYECTOS ASTRO/oslopWebPage/src/images/product-image-main-1.avif";
							}
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "D:/PROYECTOS ASTRO/oslopWebPage/src/content/products/t845.md",
							rawData: undefined,
						};
