const id = "tools/tool-guides.mdx";
						...
						const data = {title:"Tool Guides",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Tool Guides",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "D:/PROYECTOS ASTRO/oslopWebPage/src/content/docs/tools/tool-guides.mdx",
							rawData: undefined,
						};
