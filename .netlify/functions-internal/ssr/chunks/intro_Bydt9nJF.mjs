const id = "guides/intro.mdx";
						...
						const data = {title:"Introduction to ScrewFast Services",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:2,label:"Introduction to Services",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "D:/PROYECTOS ASTRO/oslopWebPage/src/content/docs/guides/intro.mdx",
							rawData: undefined,
						};
