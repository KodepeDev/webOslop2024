...
const file = "D:/PROYECTOS ASTRO/oslopWebPage/src/content/docs/es/welcome-to-docs.mdx";
...
Content.moduleId = "D:/PROYECTOS ASTRO/oslopWebPage/src/content/docs/es/welcome-to-docs.mdx";
